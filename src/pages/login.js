    ...
    <div className="d-flex w-100 h-screen flex-column align-items-center justify-content-center bg_primary">
      ...
      <div className="d-flex flex-column align-items-center bg-white w_login rounded_15">
        ...
        <form className="d-flex flex-column align-items-center aux_my60">
          <label className="text_16 text_grey line_0 mb-2 ml-3 w-100 text-left">
            Email
          </label>
          <input
            type="text"
            className="input_dark px-4 w_input_login aux_my32"
          ...
          <input
            type="text"
            className="input_dark px-4 w_input_login aux_my48"
          ...
          <Link
            to={'/principal'}
            type="button"
            className="Option d-flex align-items-center justify-content-center finalizar btn_p"
          >
            Entrar
          </Link>
        </form>
        <a href="/" className="aux_my45">
          SUPORTE WEPTECH
        </a>
      </div>
    </div>
